...
export const HeroContainerScroll: React.FC = () => {
  ...
  return (
    <div
      className="flex items-center justify-center relative pt-36 z-10"
      ref={containerRef}
    >
      <div
      ...
      >
        ...
        >
          <a
            href="#"
            className="mt-32 bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 inline-block"
          >
        ...
        <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t dark:from-background z-10" />
      </div>
    </div>
  );
};
